...
function GeneralSection() {
  ...
  return (
    <div className="space-y-5">
      <SettingRow
        label="Language"
        description="Interface language (more coming soon)"
      >
        <select
          disabled
      ...
      <SettingRow
        label="Autosave"
        description="Automatically save when changes are made"
      >
        <ToggleSwitch
...
function AppearanceSection() {
  ...
  return (
    <div className="space-y-5">
      <SettingRow
        label="Show keytips"
        description="Display keyboard shortcut badges on controls"
      >
        <ToggleSwitch
...
function EditorSection() {
  ...
  return (
    <div className="space-y-5">
      <SettingRow
        label="Grid snap"
        description="Snap elements to grid when moving on canvas"
      >
        <ToggleSwitch
          checked={settings.gridSnap}
          onChange={(v) => updateSetting("gridSnap", v)}
        />
      </SettingRow>
