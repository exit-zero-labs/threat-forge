...
Everything else — Size, Priority, Status, Type, Milestone — is a field, not a label. A new label needs the same justification bar as a new field: it must change a routing or gating decision.
